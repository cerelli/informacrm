{{-- @if ($crud->hasAccess('delete')) --}}
	@php
		...
		if ( !isset($custom_button_class) ) {
			$class = ' class="btn btn-xs btn-success " ';
		} else {
			if ( isset($custom_button_class) ) {
				$class = ' class="btn btn-xs btn-success '.$custom_button_class.'"';
			}

		}

	@endphp
	<a href='{!! $url !!}' {!! $class !!} data-button-type="assign" {!! $attributes !!}><i class="fa fa-unlock" aria-hidden="true"></i>
