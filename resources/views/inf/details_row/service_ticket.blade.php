	...
	<div class="row">
		<div class="col-md-12">
            <div class="panel-title col-md-12">
                @php
                    $title = trans('informacrm.service_ticket_creation')." ". \Carbon\Carbon::parse($entry->created_at)->format('d/m/Y');
            ...
            <div class="note col-md-12" style="margin-top: 5px; padding-bottom: 15px;">
                ...
                @else
                    {!! '<br><span style="font-size: 80%; margin-right: 3px; color: '.$entry->service_ticket_result->color.'; background-color: '.$entry->service_ticket_result->background_color.'" class="label label-default">
                            <i class= "fa  '.$entry->service_ticket_result->icon.'"></i> '.$entry->service_ticket_result->description.'
                        </span><br>' !!}
                    <div class="well" style="padding: 1px 1px 1px 10px; margin-bottom: 0px;">
