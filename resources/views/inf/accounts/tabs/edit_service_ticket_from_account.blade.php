...
<div class="row">
	<div class="col-md-8 col-md-offset-2">
		...
		@if ($crud->hasAccess('list'))
			<a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/account').'/'.$entry->account_id.'#service_tickets' }}"><i class="fa fa-angle-double-left"></i> {{ trans('backpack::crud.back_to_all') }} <span>{{ $crud->entity_name_plural }}</span></a><br><br>
		@endif
