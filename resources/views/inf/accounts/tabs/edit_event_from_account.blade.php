...
<div class="row">
	<div class="col-md-8 col-md-offset-2">
		...
		@if ($crud->hasAccess('list'))
			<a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/account').'/'.$entry->account_id.'#addresses' }}"><i class="fa fa-angle-double-left"></i> {{ trans('backpack::crud.back_to_all') }} <span>{{ $crud->entity_name_plural }}</span></a><br><br>
		@endif
            ...
            <div class="box-footer">
				...
				switch ($call) {
					case 'events_calendar':
						...
						break;
					case 'account':
						$var_annulle = config('backpack.base.route_prefix', 'admin').'/'.$call_url.'#events';
						break;
					default:
						$var_annulle = config('backpack.base.route_prefix', 'admin').'/'.$call_url.'#events';
						break;
