  ...
  <form method="post">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class="treeview">
                <a href="#"><i class="fa fa-gears"></i> <span>{{ trans('informacrm.documents') }}</span> <i class="fa fa-angle-left     pull-right"></i></a>
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/document_type') }}"><i class="fa fa-cog"></i> <span>{{ trans('general.types') }}</span></a></li>
                    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/document_status') }}"><i class="fa fa-cog"></i> <span>{{ trans('general.statuses') }}</span></a></li>
                </ul>
            </li>
        </ul>
