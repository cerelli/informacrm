...
use App\Http\Requests\Contact_typeRequest as StoreRequest;
use App\Http\Requests\Contact_typeRequest as UpdateRequest;

class Contact_typeCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Contact_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/contact_type');
        $this->crud->setEntityNameStrings(trans('informacrm.contact_type'), trans('informacrm.contact_types'));
