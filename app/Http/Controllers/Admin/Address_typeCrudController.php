...
use App\Http\Requests\Address_typeRequest as StoreRequest;
use App\Http\Requests\Address_typeRequest as UpdateRequest;

class Address_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Address_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/address_type');
        $this->crud->setEntityNameStrings(trans('informacrm.address_type'), trans('informacrm.address_types'));
