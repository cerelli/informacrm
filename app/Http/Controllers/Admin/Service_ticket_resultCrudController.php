...
use App\Http\Requests\Service_ticket_resultRequest as StoreRequest;
use App\Http\Requests\Service_ticket_resultRequest as UpdateRequest;

class Service_ticket_resultCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Service_ticket_result');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/service_ticket_result');
        $this->crud->setEntityNameStrings(trans('informacrm.service_ticket_result'), trans('informacrm.service_ticket_results'));
