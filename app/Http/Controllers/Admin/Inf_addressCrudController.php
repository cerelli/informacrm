...
use App\Http\Requests\Inf_addressRequest as StoreRequest;
use App\Http\Requests\Inf_addressRequest as UpdateRequest;

use Auth;
use Illuminate\Http\Request;

class Inf_addressCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inf_address');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/address');
        $this->crud->setEntityNameStrings('inf_address', 'inf_addresses');
    ...
    public function store(StoreRequest $request)
    {
        ...
        switch ($saveAction) {
            case 'save_and_edit':
                break;
            case 'save_and_new':
                $redirect_location = redirect(config('backpack.base.route_prefix', 'admin').'/address/create?active_account_id='.$this->crud->entry['inf_account_id']);
                break;
            case 'save_and_back':
            default:
                $redirect_location = redirect('admin/account/'.$this->crud->entry['inf_account_id'].'#addresses');
                break;
        }
        //***************************ORIGINAL********
