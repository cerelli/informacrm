...
use App\Http\Requests\Document_typeRequest as StoreRequest;
use App\Http\Requests\Document_typeRequest as UpdateRequest;
...
class Document_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Document_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/document_type');
        $this->crud->setEntityNameStrings(trans('informacrm.document_type'), trans('informacrm.document_types'));
