...
use App\Http\Requests\Service_ticket_typeRequest as StoreRequest;
use App\Http\Requests\Service_ticket_typeRequest as UpdateRequest;

class Service_ticket_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Service_ticket_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/service_ticket_type');
        $this->crud->setEntityNameStrings(trans('informacrm.service_ticket_type'), trans('informacrm.service_ticket_types'));
