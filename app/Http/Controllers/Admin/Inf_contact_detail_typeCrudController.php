...
use App\Http\Requests\Inf_contact_detail_typeRequest as StoreRequest;
use App\Http\Requests\Inf_contact_detail_typeRequest as UpdateRequest;

class Inf_contact_detail_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inf_contact_detail_type');
