...
use App\Http\Requests\Opportunity_resultRequest as StoreRequest;
use App\Http\Requests\Opportunity_resultRequest as UpdateRequest;

class Opportunity_resultCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Opportunity_result');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/opportunity_result');
        $this->crud->setEntityNameStrings(trans('informacrm.opportunity_result'), trans('informacrm.opportunity_results'));
