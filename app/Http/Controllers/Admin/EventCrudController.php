...
use App\Http\Requests\EventRequest as SelectRequest;
...
class EventCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setEntityNameStrings(trans('informacrm.event'), trans('informacrm.events'));
        ...
        */
        ...
        $this->crud->addField([       // Select2Multiple = n-n relationship (with pivot table)
            'label' => trans('informacrm.event_types').' *',
                ...
                'model' => "App\Models\Event_type", // foreign key model
            ...
            $this->crud->addField([
                ...
                'type' => 'select',
                'name' => 'event_status_id', // the db column for the foreign key
                'entity' => 'event_statuses', // the method that defines the relationship in your Model
                'attribute' => 'description', // foreign key attribute that is shown to user
                'model' => "App\Models\Event_status", // foreign key model
                'wrapperAttributes' => [
            ...
            $this->crud->addField([
                ...
                'type' => 'select',
                'name' => 'event_result_id', // the db column for the foreign key
                'entity' => 'event_results', // the method that defines the relationship in your Model
                'attribute' => 'description', // foreign key attribute that is shown to user
                'model' => "App\Models\Event_result", // foreign key model
                'wrapperAttributes' => [
                    'class' => 'form-group col-md-12'
                ]
            ]);
    ...
    public function store(StoreRequest $request)
    {
        ...
        switch ($saveAction) {
            ...
            case 'save_and_back':
            default:
                $redirect_location = redirect('admin/account/'.$this->crud->entry['account_id'].'#'.$tab);
                break;
        }
    ...
    {
        $event_result = Event::findOrFail($event_id);
        $event_result->update(['opportunity_id'=>$opportunity_id]);
