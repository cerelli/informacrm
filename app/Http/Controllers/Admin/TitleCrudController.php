...
use App\Http\Requests\TitleRequest as StoreRequest;
use App\Http\Requests\TitleRequest as UpdateRequest;
...
class TitleCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Title');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/title');
        $this->crud->setEntityNameStrings(trans('informacrm.title'), trans('informacrm.titles'));
