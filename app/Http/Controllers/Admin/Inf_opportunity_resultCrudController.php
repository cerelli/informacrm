...
use App\Http\Requests\Inf_opportunity_resultRequest as StoreRequest;
use App\Http\Requests\Inf_opportunity_resultRequest as UpdateRequest;

class Inf_opportunity_resultCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inf_opportunity_result');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/opportunity_result');
        $this->crud->setEntityNameStrings(trans('informacrm.inf_opportunity_result'), trans('informacrm.inf_opportunity_results'));
