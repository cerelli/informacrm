...
use App\Http\Requests\Document_statusRequest as StoreRequest;
use App\Http\Requests\Document_statusRequest as UpdateRequest;

class Document_statusCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Document_status');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/document_status');
        $this->crud->setEntityNameStrings(trans('informacrm.document_status'), trans('informacrm.document_statuses'));
