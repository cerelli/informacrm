...
use App\Http\Requests\Opportunity_typeRequest as StoreRequest;
use App\Http\Requests\Opportunity_typeRequest as UpdateRequest;

class Opportunity_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Opportunity_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/opportunity_type');
        $this->crud->setEntityNameStrings(trans('informacrm.opportunity_type'), trans('informacrm.opportunity_types'));
