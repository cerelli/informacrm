...
use App\Http\Requests\Contact_detailRequest as StoreRequest;
use App\Http\Requests\Contact_detailRequest as UpdateRequest;

class Contact_detailCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addField([
            'name' => 'contact_id',
            'label' => trans('informacrm.contact_id'),
            'type' => 'hidden'
        ]);
        ...
        $this->crud->addField([
            ...
            'type' => 'select2',
            'name' => 'contact_detail_type_id', // the db column for the foreign key
            'entity' => 'contact_detail_type', // the method that defines the relationship in your Model
            'attribute' => 'description', // foreign key attribute that is shown to user
            'model' => "App\Models\Contact_detail_type", // foreign key model
            'wrapperAttributes' => [
        ...
        $this->crud->addField([
            ...
            'type' => 'select2',
            'name' => 'communication_type_id', // the db column for the foreign key
            'entity' => 'communication_type', // the method that defines the relationship in your Model
            'attribute' => 'description', // foreign key attribute that is shown to user
            'model' => "App\Models\Communication_type", // foreign key model
            'wrapperAttributes' => [
                'class' => 'form-group col-md-6'
            ]
        ]);
...
// <p type="hidden" name="account_id" value="" class="form-control">
