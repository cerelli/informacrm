...
use App\Http\Requests\Inf_contact_typeRequest as StoreRequest;
use App\Http\Requests\Inf_contact_typeRequest as UpdateRequest;
...
class Inf_contact_typeCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inf_contact_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/contact_type');
        $this->crud->setEntityNameStrings(trans('informacrm.inf_contact_type'), trans('informacrm.inf_contact_types'));
