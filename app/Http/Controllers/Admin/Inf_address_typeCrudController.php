...
use App\Http\Requests\Inf_address_typeRequest as StoreRequest;
use App\Http\Requests\Inf_address_typeRequest as UpdateRequest;

class Inf_address_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inf_address_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/address_type');
        $this->crud->setEntityNameStrings(trans('informacrm.inf_address_type'), trans('informacrm.inf_address_types'));
