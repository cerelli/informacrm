...
use App\Http\Requests\Event_typeRequest as StoreRequest;
use App\Http\Requests\Event_typeRequest as UpdateRequest;

class Event_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Event_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/event_type');
        $this->crud->setEntityNameStrings(trans('informacrm.event_type'), trans('informacrm.event_types'));
