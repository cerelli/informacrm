...
use App\Http\Requests\Inf_account_typeRequest as StoreRequest;
use App\Http\Requests\Inf_account_typeRequest as UpdateRequest;

class Inf_account_typeCrudController extends CrudController
{
