...
use App\Http\Requests\Web_site_typeRequest as StoreRequest;
use App\Http\Requests\Web_site_typeRequest as UpdateRequest;

class Web_site_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Web_site_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/web_site_type');
        $this->crud->setEntityNameStrings(trans('informacrm.web_site_type'), trans('informacrm.web_site_types'));
