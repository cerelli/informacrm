...
use App\Http\Requests\Event_resultRequest as StoreRequest;
use App\Http\Requests\Event_resultRequest as UpdateRequest;

class Event_resultCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Event_result');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/event_result');
        $this->crud->setEntityNameStrings(trans('informacrm.event_result'), trans('informacrm.event_results'));
