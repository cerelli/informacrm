...
use App\Http\Requests\Communication_typeRequest as StoreRequest;
use App\Http\Requests\Communication_typeRequest as UpdateRequest;
...
class Communication_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Communication_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/communication_type');
        $this->crud->setEntityNameStrings(trans('informacrm.communication_type'), trans('informacrm.communication_types'));
