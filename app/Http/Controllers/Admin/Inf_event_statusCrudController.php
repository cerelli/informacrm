...
use App\Http\Requests\Inf_event_statusRequest as StoreRequest;
use App\Http\Requests\Inf_event_statusRequest as UpdateRequest;

class Inf_event_statusCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inf_event_status');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/event_status');
        $this->crud->setEntityNameStrings(trans('informacrm.inf_event_status'), trans('informacrm.inf_event_statuses'));
