...
use App\Http\Requests\Inf_document_statusRequest as StoreRequest;
use App\Http\Requests\Inf_document_statusRequest as UpdateRequest;

class Inf_document_statusCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inf_document_status');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/document_status');
        $this->crud->setEntityNameStrings(trans('informacrm.inf_document_status'), trans('informacrm.inf_document_statuses'));
