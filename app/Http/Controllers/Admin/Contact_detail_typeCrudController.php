...
use App\Http\Requests\Contact_detail_typeRequest as StoreRequest;
use App\Http\Requests\Contact_detail_typeRequest as UpdateRequest;

class Contact_detail_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Contact_detail_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/contact_detail_type');
        $this->crud->setEntityNameStrings('contact_detail_type', 'contact_detail_types');
