...
use App\Http\Requests\Inf_document_typeRequest as StoreRequest;
use App\Http\Requests\Inf_document_typeRequest as UpdateRequest;

class Inf_document_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inf_document_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/inf_document_type');
        $this->crud->setEntityNameStrings(trans('informacrm.inf_document_type'), trans('informacrm.inf_document_types'));
