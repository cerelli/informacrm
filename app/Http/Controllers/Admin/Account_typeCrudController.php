...
use App\Http\Requests\Account_typeRequest as StoreRequest;
use App\Http\Requests\Account_typeRequest as UpdateRequest;

class Account_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Account_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/account_type');
        $this->crud->setEntityNameStrings(trans('informacrm.account_type'), trans('informacrm.account_types'));
