...
use App\Http\Requests\Opportunity_statusRequest as StoreRequest;
use App\Http\Requests\Opportunity_statusRequest as UpdateRequest;

class Opportunity_statusCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Opportunity_status');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/opportunity_status');
        $this->crud->setEntityNameStrings(trans('informacrm.opportunity_status'), trans('informacrm.opportunity_statuses'));
