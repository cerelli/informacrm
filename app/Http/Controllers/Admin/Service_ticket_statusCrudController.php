...
use App\Http\Requests\Service_ticket_statusRequest as StoreRequest;
use App\Http\Requests\Service_ticket_statusRequest as UpdateRequest;

class Service_ticket_statusCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Service_ticket_status');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/service_ticket_status');
        $this->crud->setEntityNameStrings(trans('informacrm.service_ticket_status'), trans('informacrm.service_ticket_statuses'));
