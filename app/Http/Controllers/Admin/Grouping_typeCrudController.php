...
use App\Http\Requests\Grouping_typeRequest as StoreRequest;
use App\Http\Requests\Grouping_typeRequest as UpdateRequest;
use Auth;

class Grouping_typeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Groupings\Grouping_type');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/grouping_type');
        $this->crud->setEntityNameStrings(trans('informacrm.grouping_type'), trans('informacrm.grouping_types'));
        ...
        */
        ...
        $this->crud->addField([
            ...
            'entity' => 'user_created_by', // the method that defines the relationship in your Model
        ...
        $this->crud->addField([
            ...
            'entity' => 'user_updated_by', // the method that defines the relationship in your Model
            'attribute' => 'name', // foreign key attribute that is shown to user
            'model' => "App\User", // foreign key model
            'attributes' => ['disabled' => 'disabled'],
            'wrapperAttributes' => [
