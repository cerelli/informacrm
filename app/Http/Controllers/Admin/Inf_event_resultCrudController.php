...
use App\Http\Requests\Inf_event_resultRequest as StoreRequest;
use App\Http\Requests\Inf_event_resultRequest as UpdateRequest;

class Inf_event_resultCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inf_event_result');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/event_result');
        $this->crud->setEntityNameStrings(trans('informacrm.inf_event_result'), trans('informacrm.inf_event_results'));
