...
use App\Http\Requests\Event_statusRequest as StoreRequest;
use App\Http\Requests\Event_statusRequest as UpdateRequest;

class Event_statusCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Event_status');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/event_status');
        $this->crud->setEntityNameStrings(trans('informacrm.event_status'), trans('informacrm.event_statuses'));
